package com.fh.controller.comtest.test;
...
import com.fh.service.comtest.test.TestService;
...
public class TestController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			this.getHC(); //调用权限
			mv.setViewName("comtest/test/test_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("comtest/test/test_edit");
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var1", varOList.get(i).getString("AER1"));	//1
				varList.add(vpd);
			}
